// lang-redirect.js — synchronous classic script, loaded in <head> BEFORE
// first paint (CSP has no 'unsafe-inline', so it ships as a file). It has
// no dependency on i18n.js or nav.js.
//
...
(function () {
  ...
  // EN page path -> canonical zh page path (same map nav.js uses, plus the
  ...
  var current = lang.indexOf("zh") === 0 ? "zh" : lang.indexOf("en") === 0 ? "en" : null;
